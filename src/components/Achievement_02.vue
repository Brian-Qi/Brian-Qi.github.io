<template>
  <div class="achievement-02">
      ...
      <div class="achievement-reward">
        <div class="reward-badge">
          ...
          <div class="reward-text">
            <p>别乱点啦</p>
            <p>这一页</p>
            <p class="big-slap">真没彩蛋啦</p>
            <p class="as-reward">回去吧</p>
          </div>
          <span class="reward-icon">👋</span>
        </div>
      </div>
    ...
    <div class="disclaimer">
      <p>* 本成就没有任何实际价值，仅用于证明您确实很无聊 *</p>
      <p class="small-text">※ 这都能找到，服了你了 ※</p>
    </div>
  </div>
</template>
...
export default {
  ...
  setup() {
    ...
    onMounted(() => {
      ...
      localStorage.setItem('achieve_02', 'true')
    })
